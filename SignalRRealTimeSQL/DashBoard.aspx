<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashBoard.aspx.cs" Inherits="SignalRRealTimeSQL.DashBoard" %>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="index.aspx"><i class="fa fa-table fa-fw"></i> Stock Ticker List</a>
                            </li>
                            <li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="panel panel-green">
                                ...
                                <a href="#">
                                    <div class="panel-footer">
                                        <span class="pull-left">Add/Change Stock Ticker</span>
                                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="panel panel-yellow">
                                ...
                                <a href="#">
                                    <div class="panel-footer">
                                        <span class="pull-left">My Details</span>
                                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
